...
namespace Common
{
    ...
    public static class JsonExtension
    {
        ...
        {
            var _tryConvertResult = new ConvertJsonResult
            {
            ...
            if (obj == null)
                return _tryConvertResult;

            try
            {
                _tryConvertResult.ConvertData = JsonConvert.SerializeObject(obj);
                _tryConvertResult.IsConvertSuccess = true;
            }
            catch (Exception) { }
        ...
        public static ConvertJsonResult M5_TryObjectToJson(this object obj, Formatting format)
        {
            ...
            try
            {
                _tryConvertResult.ConvertData = JsonConvert.SerializeObject(obj, format);
                _tryConvertResult.IsConvertSuccess = true;
            }
            catch (Exception) { }
        ...
        {
            var _tryConvertResult = new ConvertJsonResult<T>
            {
                IsConvertSuccess = false,
            ...
            try
            {
                _tryConvertResult.ConvertData = JsonConvert.DeserializeObject<T>(obj);
                _tryConvertResult.IsConvertSuccess = true;
            }
            catch (Exception) { }
        ...
        public static ConvertJsonResult<T> M5_TryJsonToObject<T>(dynamic json) where T : class
        {
            ...
            try
            {
                _tryConvertResult.ConvertData = JsonConvert.DeserializeObject<T>(Convert.ToString(json));
                _tryConvertResult.IsConvertSuccess = true;
            }
            catch (Exception) { }
